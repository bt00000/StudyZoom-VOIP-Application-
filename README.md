...
```bash
$ # Get the code
$ git clone https://github.com/bt00000/StudyZoom-VOIP-Application-.git
$ cd <YOUR_BUILD_ID>
```
...
![study_zoom1](https://github.com/user-attachments/assets/87acd6a9-50df-4795-83f5-f0ea685d943e)
...
![agora_pic](https://github.com/user-attachments/assets/5f614be9-16fb-4cdc-ab4f-7613ebbd70a9)
